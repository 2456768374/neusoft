...
<body style="width:1000px; margin:0 auto;height: 720px">
<div class="row">
...
<div style="border-style: solid; width: 350px; height: 90px; border-width: 0.5px;
    ...
    <div class="col-lg-12" style="height: 120px;line-height: 100px;text-align: center; margin-top: -7px;
				font-family: times new roman;font-weight: 400;font-size: 300%; color: aliceblue;">用户登录</div>
</div>
        ...
        <form class="bs-example bs-example-form" role="form"
            ...
            <div class="input-group" style="width: 250px; margin: 20px auto;">
                ...
                <input type="password" id="upwd" name="upwd" class="form-control"
                       onblur="checkInputforReg(this.id,regUserName,'密码格式不正确')"/>
                <span id="upwdTip"></span>
            </div>
            <button class="btn btn-lg btn-primary btn-block" type="submit"
                    style="width: 250px; margin: 30px auto; background-color: #337ab7;
							border-width: 0.5px; border-color: #87CEFA;">登录</button>
        </form>
        <button class="btn btn-lg btn-primary btn-block" type="button"
                style="width: 250px; margin: 30px auto; background-color: #337ab7;
							border-width: 0.5px; border-color: #87CEFA;">
            <a href="register.jsp" style="text-decoration:none; color: #ffffff;">注册</a>
        </button>
    </div>
</div>
