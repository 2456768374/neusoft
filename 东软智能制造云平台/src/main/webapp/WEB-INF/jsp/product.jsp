<template:user_backend htmlTitle="计划信息表" bodyTitle="查看计划信息">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="example-navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/product/selecta.do">产品管理</a></li>
    ...
    <div class="panel panel-default " >
        ...
        <div class="panel-heading clearfix">
                <%--      加float控制在同一行，用margin-left控制左右间距      --%>
            <button class="btn btn-primary" style="color: #ffffff; float: left" data-toggle="modal" data-target="#myModal">
                新增产品
            </button>
            <a href="/product/selecta.do"><button class="btn btn-primary" style="color: #ffffff; float: left; margin-left: 10px">显示全部</button></a>

                <%--           用提交表单的形式，action里面写要提交给控制层的哪个方法        --%>
            <form class="bs-example bs-example-form" role="form"
                  action="/product/selectByName.do"
                  onsubmit="return true;">
                <div class="input-group" style="width: 170px; float: left; margin-left: 50px">
                    <span class="input-group-addon">产品名称</span>
                    <input type="text" id="" name="product_name" class="form-control">
                </div>
                <div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="width: auto;height: auto;">
                            <form action="/product/add.do" enctype="multipart/form-data">
...
<%--                                    <input type="text" style="width: auto;"--%>
<%--                                           class="form-control"  name="product_img_url" />--%>
<%--                                </div>--%>
                                <div class="form-group ">
                                    <label class="control-label">产品名称</label>
                                    <input type="text" style="width: auto;"
                                           class="form-control" placeholder="请输入产品名称" name="product_name"/>
                                </div>
...
<%--                    <td>${product.productImgUrl}</td>--%>
                    ...
                    <td>
<%--                        <button class="btn  btn-xs btn-info" style="color: white;">--%>
<%--                            <span class="glyphicon glyphicon-list"></span>--%>
<%--                            <a href="/plan/updateByStatus.do?plan_num=${productPlan.planNum}">--%>
<%--                                编辑</a>--%>
<%--                        </button>--%>
                        <button class="btn  btn-xs btn-danger ticketDel">
                            <span class="glyphicon glyphicon-user">
                                <a href="/product/deleteByNum.do?product_num=${product.productNum}">
                                    删除</a></span>
                        </button>
